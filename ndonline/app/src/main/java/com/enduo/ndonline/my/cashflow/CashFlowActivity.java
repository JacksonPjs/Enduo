...
public class CashFlowActivity extends BaseActivity implements LoadingLayout.OnReloadListener, LoadMoreRecyclerLoadingLayout.OnRefreshAndLoadMoreListener {
    ...
    private void net(final int stype, final int inrefresh) {
        NetWorks.moneyFlow(page + "", pagesize + "", new Subscriber<CaseFlowBean>() {
            @Override
    ...
    private void initView() {
        ...
        adapter = new CashFlowAdapter(biaoBeenList, this);
                ...
                SharedPreferencesUtils.getPassword(this), new Subscriber<LoginBean>() {
                    ...
                    public void onNext(LoginBean loginBean) {
                        if (loginBean.getState().getStatus() == 0) {
                            ...
                            SharedPreferencesUtils.setIsLogin(CashFlowActivity.this,false);
                        }
                    }
                }
        );
