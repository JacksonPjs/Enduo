...
public class Fragment_new extends Fragment implements LoadingLayout.OnReloadListener, LoadMoreRecyclerLoadingLayout.OnRefreshAndLoadMoreListener {
    ...
    private void net(final int stype, final int inrefresh) {
        NetWorks.selectBorrowListApp(page + "", pagesize + "","8", new Subscriber<BiaoBean>() {
            @Override
